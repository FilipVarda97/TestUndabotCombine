//
//  TUCUserDetailsInfoCollectionViewCell.swift
//  TestUndabotCombine
//
...
final class TUCUserDetailsInfoCollectionViewCell: UICollectionViewCell {
    static let identifier = "TUCUserDetailsInfoCollectionViewCell"
    ...
    public func configure(with viewModel: TUCUserDetailsInfoCollectionViewCellViewModel) {
